  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route element={<RequireAuth><StonecodePrototype settingsSection="api-keys" /></RequireAuth>} path="/settings/api-keys" />
        ...
        <Route element={<RequireAuth><StonecodePrototype settingsSection="preferences" /></RequireAuth>} path="/settings/preferences" />
