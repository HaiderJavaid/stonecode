...
let scenes = [
    PromoScene(id: "discovery", windowTitle: "Add learning", eyebrow: "AI DISCOVERY", title: "What would you like to learn or build?", copy: "Tell Stonecode your goal in your own words. Suggested answers help, but free typing is always available.", rail: ["Goal", "Background", "Preferences", "Review"], actions: ["JavaScript course", "Browser project", "Help me choose"], accent: NSColor(calibratedRed: 0.62, green: 0.46, blue: 0.96, alpha: 1)),
    PromoScene(id: "assessment", windowTitle: "Review proposal", eyebrow: "DETERMINISTIC QUOTE", title: "Edit the plan before creation.", copy: "Review the exact syllabus, project steps, or exercise list together with its credit cost before reserving anything.", rail: ["Goal", "Background", "Proposal", "Quote"], actions: ["Edit outline", "Approve and create", "Back"], accent: NSColor(calibratedRed: 0.86, green: 0.67, blue: 0.33, alpha: 1)),
...
let narrationText = "AI can generate code in seconds. Understanding it gives you control. Tell Stonecode what you want to learn or build, and share what you already know. Review an editable learning proposal and deterministic credit quote before creation. Stonecode turns that context into a personal course, guided project, or exercise pack shaped around your goal. Learn each concept in plain language. Ask your AI tutor questions without leaving the lesson. Build through one meaningful code change at a time, inspect real browser output or console results, and get feedback that explains what still needs attention. Every verified result builds language experience, progress, and achievements. Every account starts with included creation credits, and Pro adds more each billing cycle."
