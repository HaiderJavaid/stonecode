...
export const courseLanguageCapabilities = [
  ...
  capability({ id: "basic", label: "BASIC", aliases: [/\bbasic\b/i, /qbasic/i, /visual basic/i], filePath: "main.bas", extensions: ["bas", "vb"], outputVerb: "Print", starterCode: "Dim message As String = \"Value: stone\"\nPrint message\n", family: "legacy" }),
