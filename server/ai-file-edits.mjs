export function extractAiFileEdits(reply) {
  const edits = [];
  let displayReply = reply.replace(/```STONECODE_FILE_EDIT\s*([\s\S]*?)```/g, (_match, rawJson) => {
...
function parseJsonEdit(rawJson) {
  try {
